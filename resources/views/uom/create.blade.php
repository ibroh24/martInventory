    ...
    <div class="card-box">
        <div class="row">
            <div class="col-sm-12 col-xs-12 m-t-20">
                <h4 class="header-title m-t-0">Create UOM</h4>
                <hr>
                ...
                <div class="p-20">
                    <form method="POST" action="{{route('measure.store')}}">
                      ...
                      @endif
                        <div class="row">
                          <div class="col-md-6">
                            <input type="text" name="uomname" class="form-control" placeholder="UOM Name">
                          </div>
                          <div class="col-md-6">
                            <input type="text" name="uomdescription" class="form-control" placeholder="UOM Description">
                            {{-- <input type="hidden" hidden name="uomslug" class="form-control"> --}}
                          </div>
                        </div>
