...
@section('title')
    Faajs | Update Measurement
@endsection

@section('breadcrumb')
    Measurement Setup Update
@endsection
@section('menuname')
    Measurement
@endsection
    ...
    <div class="card-box">
        <div class="row">
            <div class="col-sm-12 col-xs-12 m-t-20">
                <h4 class="header-title m-t-0">Edit {{$editUOM->uomname}}'s Data</h4>
                <hr>
                ...
                <div class="p-20">
                    <form method="POST" action="{{route('measure.update', $editUOM->uomslug)}}">
                        {{ csrf_field() }}
                        @if (count($errors) > 0)
                      ...
                      @endif
                        <div class="row">
                          <div class="col-md-6">
                            <input type="text" name="uomname" value="{{$editUOM->uomname}}" class="form-control" placeholder="UOM Name">
                          </div>
                          <div class="col-md-6">
                            <input type="text" name="uomdescription" value="{{$editUOM->uomdescription}}" class="form-control" placeholder="UOM Description">
                          </div>
                        </div>
                          ...
                          <div class="form-group m-t-30" style="margin-left: 70%">
                            {{-- <div> --}}
                                ...
                                <a href="{{route('measure.view')}}" type="reset" class="btn btn-warning waves-effect m-l-5 w-md">
                                    Cancel
                                </a>
                            {{-- </div> --}}
                        </div>
