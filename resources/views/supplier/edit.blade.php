    ...
    <div class="card-box">
        <div class="row">
            <div class="col-sm-12 col-xs-12 m-t-20">
                <h4 class="header-title m-t-0">Edit {{$editSupplier->suppliername}}'s Information</h4>
                <hr>
                ...
                <div class="p-20">
                    <form method="POST" action="{{route('supplier.update', $editSupplier->supplierslug)}}">
                        {{ csrf_field() }}
                        @if (count($errors) > 0)
                      ...
                      @endif
                        <div class="row">
                          <div class="col-md-6">
                            <input type="text" name="suppliername" value="{{$editSupplier->suppliername}}" class="form-control" placeholder="Supplier Name">
                          </div>
                          <div class="col-md-6">
                            <input type="text" name="phone" value="{{$editSupplier->phone}}" class="form-control" placeholder="Supplier Phone Number">
                          </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                              <input type="text" name="address" value="{{$editSupplier->address}}" class="form-control" placeholder="Supplier Address">
                            </div>
                            <div class="col-md-6">
                                <select class="form-control" value="{{$editSupplier->suppliedproduct}}" name="suppliedproduct">
                                    <option>Select Product Category</option>
                                    @foreach ($productCategories as $category)

                                    <option class="m-t-20" value="{{$category->categoryname}}"
                                        @if ($editSupplier->suppliedproduct == $category->categoryname)
                                            selected
                                        @endif
