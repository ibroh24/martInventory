    ...
    <div class="card-box">
        <div class="row">
            <div class="col-sm-12 col-xs-12 m-t-20">
                <h4 class="header-title m-t-0">User Bio-Data</h4>
                <hr>
                ...
                <div class="p-20">
                    <form method="POST" action="{{route('user.store')}}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          ...
                          <div class="row">
                            <div class="col-md-6">
                              <input type="file" name="avatar" class="form-control" placeholder="Upload Image">
                            </div>
                            <div class="col-md-6">
                                <input type="text" readonly name="slug" class="form-control" placeholder="Slug">
                            </div>
                          </div>
                          ...
                          <div class="form-group m-t-30" style="margin-left: 70%">
                                ...
                                <a type="reset" href="{{route('user.view')}}"  class="btn btn-warning waves-effect m-l-5 w-md">
                                    Cancel
                                </a>
                        </div>
                      </form>
