...
@section('title')
    Faajs | Edit Categories
@endsection

@section('breadcrumb')
    Categories Setup Update
@endsection
@section('menuname')
    Categories
@endsection
...
<div class="col-xs-12">
    <div class="card-box">
        <div class="row">
            ...
            <h4 class="header-title m-t-0">Edit {{$editcategory->categoryname}}'s Category</h4>
                <hr>
                ...
                <div class="p-20">
                    <form method="POST" action="{{route('category.update',  $editcategory->categoryslug)}}">
                        {{ csrf_field() }}
                        @if (count($errors) > 0)
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <input type="text" value="{{$editcategory->categoryname}}" name="categoryname" class="form-control" placeholder="Category Name">
                          </div>
                          <div class="col-md-6">
                            <input type="text" value="{{$editcategory->categorydesc}}" name="categorydesc" class="form-control" placeholder="Category Description">
                          </div>
                        </div>
                        {{-- <div class="row">
                          <div class="col-md-6">
